...
**Founding AI Engineer · Head of Engineering · Founder at [Friendly](https://usefriendly.app)**
...
### Founder & Software Engineer — [Friendly](https://usefriendly.app)

Building privacy-first, local-first products for personal knowledge, time, and mobile productivity.

Current products include:

- **[Notely](https://usefriendly.app/products/notely)** — a local-first knowledge workspace with encrypted SQLite libraries, on-device semantic search, OCR, transcription, graph navigation, tasks, files, and Canvas
- **[Timely](https://usefriendly.app/products/timely)** — a private macOS calendar combining events, Apple Reminders, local meeting notes, and keyboard-first workflows
- **[Barely](https://github.com/friendlyglobal/barely)** — a privacy-first Android launcher built with Kotlin and Jetpack Compose
...
### [From manual operations to an AI-powered B2B platform](./case-studies/manual-operations-to-ai-powered-b2b-platform.md)
...
### [Making a critical workflow 21× faster while reducing cloud costs](./case-studies/workflow-performance-and-cloud-cost-optimization.md)
...
### [Barely](https://github.com/friendlyglobal/barely)
...
### [Scope](https://github.com/gabesanto/Scope)
...
### [NASA Space Apps Challenge Brasília — First Place](https://github.com/gabesanto/nasaOnFire)
...
**Contact:** [Tell me what you are building](mailto:espiritosanto.gabriel@gmail.com?subject=Consulting%20inquiry&body=Company%3A%0AWhat%20are%20you%20trying%20to%20build%20or%20improve%3F%0ACurrent%20bottleneck%3A%0ATimeline%3A) · [LinkedIn](https://www.linkedin.com/in/gabesanto)
